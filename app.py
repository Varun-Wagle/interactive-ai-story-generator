...
def generate_story(theme, length, temperature, top_p, characters, setting, mood):
    ...
    output = generator(prompt, max_new_tokens=length, temperature=temperature, top_p=top_p, repetition_penalty=1.5, do_sample=True, num_return_sequences=1, eos_token_id=50256)
